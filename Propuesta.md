<img width="200" alt="logo_fiuba" src="https://github.com/user-attachments/assets/8aec164a-7a4a-470e-9991-086afb1a2929" />
...
- **Hardware Obligatorio:**
    ...
    - **Soporte:** Placa experimental perforada con componentes y conectores soldados, interconectados mediante cables.
- **Hardware Adicional:**
...
- **Base de tiempo:** Tick de 1mS (Systick con Callbacks) para gestionar el refresco del LCD (no bloqueante) y el parpadeo de LEDs.
...
| --- | --- | --- | --- |
| REQ-01 | Funcional | El sistema debe medir SpO2 y Frecuencia Cardíaca. | Alta |
...
- **Precondición:** El sistema se encuentra en el estado NORMAL monitoreando a un paciente.
- **Flujo principal:**
    ...
    3. El sistema detecta la anomalía y transiciona al estado ALARMA_MEDICA.
...
- **Flujo principal:**
    ...
    2. El sistema recibe el comando por UART e ingresa al estado SET_UP.
    ...
    5. El sistema actualiza el LCD confirmando la configuración y retorna al estado NORMAL.
...
- **Flujo principal:**
    ...
    3. El sistema detecta el error y transiciona al estado FALLA.
